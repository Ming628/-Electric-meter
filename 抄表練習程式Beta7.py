...
# def 初始化
def initial():
    main_window.title("台灣電力公司  - 抄 表 練 習 程 式 v1.0 by Ming")
    main_window.geometry('800x300')
    label = tk.Label(main_window,text="抄 表 練 習 程 式",bg = 'SpringGreen3',font=('Arial Black',15)).place(x=2,y=3)
    circle_frame(Ox,Oy)
...
text_box = tk.Entry(main_window,width=6,font = "Helvetica 24 bold")
text_box.place(x=350,y=250)
start_btn.place(x=230,y=210)

ptr_chkbox=Checkbutton(main_window, text="不顯示刻度", command = setor_ptr,font="Helvetica 15 bold",fg='lime green').place(x=20,y=200)
num_chkbox=Checkbutton(main_window, text="不顯示數字", command = setor_num ,font="Helvetica 15 bold",fg='lime green').place(x=20,y=230)
HC_chkbox=Checkbutton(main_window, text="模擬HC數字鍵盤", command = setor_HCkeymode ,font="Helvetica 15 bold",fg='lime green').place(x=20,y=260)
font_chkbox=Checkbutton(main_window, text="Arial Black/Bahnschrift Bold", command = setor_font ,font="Helvetica 15 bold",fg='lime green').place(x=480,y=265)
