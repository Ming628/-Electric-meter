...
# def 初始化
def initial():
    main_window.title("台灣電力公司  - 抄 表 練 習 程 式 Beta9 by Ming")
    main_window.geometry('800x320')
    label = tk.Label(main_window,text="抄 表 練 習 程 式 Beta9",bg = 'SpringGreen3',font=('Bahnschrift Bold',13)).place(x=2,y=3)
    circle_frame(Ox,Oy)
    central_dot(Ox,Oy,"gold")
